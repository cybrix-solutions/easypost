...
class CarrierTypesMock extends EasyPostMock
{
    protected string $urlPattern = '/v2\\/carrier_types$/';

    protected function getPayload(): array
    {
        return [
            $this->betterTrucksAccount(),
            $this->fedexAccount(),
            $this->speedeeAccount(),
            $this->upsAccount(),
        ];
    ...
    protected function betterTrucksAccount(): array
    {
        return [
            'object' => 'CarrierType',
    ...
    protected function fedexAccount(): array
    {
        return [
            'object' => 'CarrierType',
            'type' => 'FedexAccount',
